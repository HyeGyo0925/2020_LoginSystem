...
<c:otherwise>
	...
	<tr style="height: 150px;vertical-align: inherit;text-align: center;">
		...
		<td style="height: 150px;vertical-align: inherit;" ><fmt:formatDate value="${member.registerDate}" type="date" pattern="YYYY/MM/dd HH:mm:SS" /></td>
